...
RegisterNetEvent("QBCore:Client:OnPlayerLoaded", function()
    ObjectList = QBCore.Functions.TriggerRpc("op-utils:object:GetList");
...
RegisterNetEvent("op-utils:client:create-object", function(ref, model, x, y, z, w, culling, freeze)
    CreateObject(ref, model, x, y, z, w, culling, freeze)
end)

RegisterNetEvent("op-utils:client:delete-object", function(ref)
    DeleteObject(ref)
end)
