...
function ShopShell:GunSmith()
    return {
        event = "op-core:client:weapon:open-gunsmith",
        icon = "fas fa-store",
...
function ShopShell:ZkeaUpgrade()
    return {
        event = "op-core:client:housing:open-upgrades-menu",
        icon = "fas fa-store",
        label = "Améliorations",
        canInteract = function()
...
function ShopShell:GetRemoveClothAction()
    return {
        event = "op-core:client:crimi:remove-cloth",
    ...
    exports["qb-target"]:AddTargetModel(self.ped, {
        options = {
            ...
            self:ZkeaUpgrade(),
            {
                ...
                label = "Collecter",
                canInteract = function()
                    return exports["op-core"]:CanBagsBeCollected(currentShopBrand, currentShop)
                end,
                blackoutGlobal = true,
                blackoutJob = true,
                action = function()
                    TriggerServerEvent("op-core:server:job:stonk:collect", currentShopBrand, currentShop)
                end,
            },
        },
        distance = 2.5,
