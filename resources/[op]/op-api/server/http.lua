...
SetHttpHandler(function(req, res)
    local authorizationHeader = GetAuthorizationHeader(GetConvar("op_api_username", "admin"), GetConvar("op_api_password", "admin"))
    ...
    if req.path == "/active-players" and req.method == "GET" then
        ...
        for index = 0, playerCount - 1 do
            ...
            data[QBCore.Functions.GetopIdentifier(source)] = source
        end
