...
local function powerOnRadio()
    exports["op-voip"]:SetRadioShortRangePowerState(true)
...
local function powerOffRadio()
    ...
    exports["op-voip"]:SetRadioShortRangePowerState(false)
end
RegisterNetEvent("op-talk:client:PowerOffRadio", function()
    powerOffRadio()
end)
...
RegisterNUICallback("radio/change_volume", function(data, cb)
    ...
    if data.primary then
        exports["op-voip"]:SetRadioShortRangePrimaryVolume(data.primary)
    ...
    if data.secondary then
        exports["op-voip"]:SetRadioShortRangeSecondaryVolume(data.secondary)
