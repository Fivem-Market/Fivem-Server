Citizen.CreateThread(function()
    while true do
        local processingItems = exports["op-inventory"]:GetAllItems(GarbageConfig.Processing.ProcessingStorage)
        ...
        if #processingItems > 0 then
            ...
            for _, item in pairs(processingItems) do
                if remainingItemToProcess > 0 then
                    ...
                    if exports["op-inventory"]:RemoveItem(GarbageConfig.Processing.ProcessingStorage, item.item.name, itemAmount) then
