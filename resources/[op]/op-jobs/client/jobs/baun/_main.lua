...
RegisterNetEvent("op-jobs:client:baun:createCocktailBox", function()
    QBCore.Functions.TriggerCallback("op-jobs:server:baun:createCocktailBox", function()
    end)
end)
...
exports["qb-target"]:AddBoxZone("baun:bahama:duty", vector3(-1388.11, -606.23, 30.32), 0.55, 0.55,
                                ...
                                {options = opJobCore.Functions.GetDutyActions("baun"), distance = 2.5})
