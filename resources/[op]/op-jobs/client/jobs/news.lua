...
CreateThread(function()
    exports["qb-target"]:AddBoxZone("news:duty", vector3(-587.75, -934.67, 23.82), 0.4, 0.8, {
        ...
        minZ = 23.72,
        maxZ = 24.32,
    }, {options = opJobCore.Functions.GetDutyActions("news"), distance = 2.5})
...
RegisterNetEvent("jobs:client:news:SellNewspaper", function()
    ...
    exports["op-hud"]:DrawNotification("Une station a besoin de journaux. Sa position est sur ton ~y~GPS", "info")
end)
