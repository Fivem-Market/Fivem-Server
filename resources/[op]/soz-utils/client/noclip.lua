...
local function SetNoClip(val)
    if (isNoClipping ~= val) then
        ...
        if (isNoClipping) then
            TriggerEvent("op-core:client:admin:noclip:enabled")
            ...
            exports["op-voip"]:MutePlayer(true)
            Citizen.CreateThread(function()
                ...
                ResetEntityAlpha(clipped);
                exports["op-voip"]:MutePlayer(false)
                Citizen.Wait(500);
            ...
            TriggerEvent("op-core:client:admin:noclip:disabled")
