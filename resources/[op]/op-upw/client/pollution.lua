...
Citizen.CreateThread(function()
    PollutionLevel = QBCore.Functions.TriggerRpc("op-upw:server:GetPollutionLevel")

    Citizen.Wait(15 * 60 * 1000)
end)

RegisterNetEvent("op-upw:client:onPollutionLevelChanged", function(newPollutionLevel)
