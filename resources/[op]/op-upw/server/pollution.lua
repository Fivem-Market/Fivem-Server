QBCore.Functions.CreateCallback("op-upw:server:GetPollutionLevel", function(source, cb)
...
QBCore.Functions.CreateCallback("op-upw:server:GetPollutionPercent", function(source, cb, asString)
