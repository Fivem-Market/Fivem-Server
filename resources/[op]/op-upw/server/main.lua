...
QBCore.Functions.CreateCallback("op-upw:server:GetFacilitiesFromDb", function(source, cb, types)
...
RegisterNetEvent("op-upw:server:AddFacility", function(model, coords, scope, job)
    ...
    TriggerClientEvent("op-upw:client:CreateZone", -1, identifier, propData.facility, zone, data)
end)
