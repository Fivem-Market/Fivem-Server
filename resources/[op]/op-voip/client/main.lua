...
local serverAddress = GetConvar("op_voip_mumble_address", "")
local serverPort = GetConvarInt("op_voip_mumble_port", 64738)
...
RegisterNetEvent("voip:client:reset", function()
    ...
    exports["op-hud"]:DrawNotification("Arret de la voip...", "info")
    ...
    restarting = false
    exports["op-hud"]:DrawNotification("Voip réactivée.", "info")
end)
