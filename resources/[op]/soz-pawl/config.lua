...
Config.Craft = {
    ...
    ["cabinet_zkea"] = {
        ...
        RewardTier = {
            [1] = {Id = 4, Name = "Divin", Chance = GetConvarInt("op_pawl_craft_chance_tier_4", 25)},
            [2] = {Id = 3, Name = "Sublime", Chance = GetConvarInt("op_pawl_craft_chance_tier_3", 25)},
            [3] = {Id = 2, Name = "Joli", Chance = GetConvarInt("op_pawl_craft_chance_tier_2", 25)},
            [4] = {Id = 1, Name = "Banal", Chance = GetConvarInt("op_pawl_craft_chance_tier_1", 25)},
        },
        RewardAmount = 1,
    },
}
