...
Citizen.CreateThread(function()
    RequestStreamedTextureDict("op_minimap", false)
    while not HasStreamedTextureDictLoaded("op_minimap") do
        Wait(100)
    end

    AddReplaceTexture("platform:/textures/graphics", "radarmasksm", "op_minimap", "radarmasksm")
    AddReplaceTexture("minimap", "blips_texturesheet_ng", "op_minimap", "blips_texturesheet_ng")
    AddReplaceTexture("minimap", "blips_texturesheet_ng_2", "op_minimap", "blips_texturesheet_ng_2")
