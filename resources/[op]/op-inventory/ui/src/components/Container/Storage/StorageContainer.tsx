...
import { InventoryItem, opInventoryModel } from '../../../types/inventory';
...
export const StorageContainer = () => {
    ...
    const [playerInventory, setPlayerInventory] = useState<opInventoryModel | null>();
    const [targetInventory, setTargetInventory] = useState<opInventoryModel | null>();
    ...
    const handleInventoryUpdate = useCallback((apiResponse: {sourceInventory?: opInventoryModel; targetInventory?: opInventoryModel; inverse: boolean}) => {
    ...
    const transfertItem = useCallback((event: DragEndEvent) => {
        ...
        if (event.active.id == 'player_drag_money_') {
            ...
            fetch(`https://op-inventory/transfertMoney`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json; charset=UTF-8",
                },
            ...
            fetch(`https://op-inventory/sortItem`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json; charset=UTF-8",
                },
            ...
            fetch(`https://op-inventory/transfertItem`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json; charset=UTF-8",
                },
