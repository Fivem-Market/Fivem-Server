...
function StartGame()
    -- Load default player
    local player = QBCore.Functions.TriggerRpc("op-character:server:GetDefaultPlayer");
...
function LogExistingPlayer(player, shutdownLoadingScreen)
    ...
    local playerObject = QBCore.Functions.TriggerRpc("op-character:server:LoginPlayer", player)
