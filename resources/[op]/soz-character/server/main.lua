...
RegisterNetEvent("op-character:server:SetPlayerClothes", function(clothes)
...
RegisterNetEvent("op-character:server:SetPlayerJobClothes", function(clothes, merge)
    local Player = QBCore.Functions.GetPlayer(source)
    local clothConfig = Player.PlayerData.cloth_config
...
RegisterNetEvent("op-character:server:SetPlayerTemporaryClothes", function(clothes, merge)
    local Player = QBCore.Functions.GetPlayer(source)
    local clothConfig = Player.PlayerData.cloth_config
...
RegisterNetEvent("op-character:server:UpdateClothConfig", function(key, value)
    local player = QBCore.Functions.GetPlayer(source)
    local clothConfig = player.PlayerData.cloth_config
