...
function closeBanking() {
    $.post("https://op-bank/NUIFocusOff", JSON.stringify({}));
};
...
$(function() {
    ...
    $("#initiateWithdraw").click(function() {
        ...
        if(amount !== undefined && amount > 0) {
            ...
            $.post('https://op-bank/doWithdraw', JSON.stringify({
                isATM: isATM,
                atmType: atmType,
                atmName: atmName,
    ...
    $("#initiateDeposit").click(function() {
        ...
        if(amount !== undefined && amount > 0) {
            ...
            $.post('https://op-bank/doDeposit', JSON.stringify({
                isATM: isATM,
                atmType: atmType,
                atmName: atmName,
                account: $("#accountNumber").text(),
    ...
    $("#initiateTransfer").click(function() {
        ...
        if(amount !== undefined && amount !== null && amount > 0 && account !== '') {
            ...
            $.post('https://op-bank/doTransfer', JSON.stringify({
    ...
    $("#openOffshore").click(function() {
        $.post('https://op-bank/createOffshoreAccount', JSON.stringify({ account: $("#accountNumber").text() }))
    });
    ...
    $("#makeOffShoreTransfer").click(function() {
        ...
        if(amount !== undefined && amount > 0) {
            $.post('https://op-bank/doOffshoreDeposit', JSON.stringify({
                account: $("#accountNumber").text(),
                amount: parseInt(amount)
            }));
            $('#OffShoreTAmount').val('');
