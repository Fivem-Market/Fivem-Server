...
AddEventHandler("housing:client:ShowGarageMenu", function(propertyId)
    local property = Properties[propertyId]
    if property then
        TriggerEvent("op-core:client:vehicle:garage:house:open-menu", property:GetIdentifier())
    end
end)
...
AddEventHandler("housing:client:ShowGarageParking", function(propertyId)
    local property = Properties[propertyId]
    if property then
        TriggerEvent("op-core:client:vehicle:garage:house:show-parking", property:GetIdentifier())
    end
end)
