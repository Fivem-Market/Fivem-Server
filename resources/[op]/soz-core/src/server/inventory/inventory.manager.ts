...
export class InventoryManager {
    ...
    private opInventory: any;

    public constructor() {
        this.opInventory = exports['op-inventory'];
    }
    ...
    public search(
        ...
        return this.opInventory.Search(source, searchType, itemId, metadata);
    }
    ...
    public removeItemFromInventory(
        ...
        return this.opInventory.RemoveItem(source, itemId, amount, metadata, slot);
    }
    ...
    public addItemToInventory(
        ...
        this.opInventory.AddItem(source, itemId, amount, metadata, slot, (s, r) => {
            success = s;
            reason = r;
        });
    ...
    public canCarryItem(source: number, itemId: string, amount: number, metadata?: InventoryItemMetadata): boolean {
        return this.opInventory.CanCarryItem(source, itemId, amount, metadata);
    }
    ...
    public canCarryItems(
        ...
        return this.opInventory.CanCarryItems(source, items, metadata);
    }
    ...
    public canSwapItem(
        ...
        return this.opInventory.CanSwapItem(source, firstItemId, firstItemAmount, secondItemId, secondItemAmount);
    }
    ...
    // TODO: Implement the following method in op core directly
