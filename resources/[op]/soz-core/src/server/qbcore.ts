...
export class QBCore {
    ...
    public hasPermission(source: number, permission: opRole): boolean {
        return this.QBCore.Functions.HasPermission(source, permission);
    }

    public getSteamIdentifier(source: number): string {
        return this.QBCore.Functions.GetopIdentifier(source);
    }
    public hasJobPermission(
        ...
        return this.opJobCore.Functions.HasPermission(job, playerJobId, playerJobGrade, permission);
    }
}
