...
export const MenuVehicleDealership: FunctionComponent<MenuVehicleDealershipProps> = ({ data }) => {
    ...
    return (
        <Menu type={MenuType.VehicleDealership}>
            <MainMenu>
                <MenuTitle banner="https://nui-img/op/menu_shop_vehicle_car">Concessionaire</MenuTitle>
                <MenuContent>
                ...
                sortedCategories.map((category, index) => {
                    return (
                        <SubMenu id={`category_${index}`} key={index}>
                            <MenuTitle banner="https://nui-img/op/menu_shop_vehicle_car">{category.name}</MenuTitle>
                            <MenuContent>
                                <MenuVehicleList
