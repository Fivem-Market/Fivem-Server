...
export const EventMetadataKey = 'op_core.decorator.event';
export const NuiEventMetadataKey = 'op_core.decorator.nui_event';
export const GameEventMetadataKey = 'op_core.decorator.game.event';
...
export const OnceMetadataKey = 'op_core.decorator.once';
