...
export const MenuBennysUpgradeVehicle: FunctionComponent<MenuBennysUpgradeVehicleProps> = ({ data }) => {
    ...
    return (
        <Menu type={MenuType.BennysUpgradeVehicle}>
            <MainMenu>
                <MenuTitle banner="https://nui-img/op/menu_job_bennys">Station entretien</MenuTitle>
                <MenuContent>
            ...
            <SubMenu id="colors">
                <MenuTitle banner="https://nui-img/op/menu_job_bennys">Couleur et aspects</MenuTitle>
                <MenuContent>
                    {options?.livery && (
                        <MenuItemSelect
                            onChange={(index, value) => {
            ...
            <SubMenu id="body">
                <MenuTitle banner="https://nui-img/op/menu_job_bennys">Carrosserie</MenuTitle>
                <MenuContent>
                    <MenuItemVehicleModification
                        initialConfig={data?.originalConfiguration}
                        modKey="spoiler"
            ...
            <SubMenu id="wheel">
                <MenuTitle banner="https://nui-img/op/menu_job_bennys">Roues</MenuTitle>
                <MenuContent>
            ...
            <SubMenu id="exterior">
                <MenuTitle banner="https://nui-img/op/menu_job_bennys">Exterieur</MenuTitle>
                <MenuContent>
                    <MenuItemSelect
            ...
            <SubMenu id="interior">
                <MenuTitle banner="https://nui-img/op/menu_job_bennys">Intérieur</MenuTitle>
                <MenuContent>
                    <MenuItemVehicleModification
                        initialConfig={data?.originalConfiguration}
                        modKey="horn"
            ...
            <SubMenu id="light">
                <MenuTitle banner="https://nui-img/op/menu_job_bennys">Lumières</MenuTitle>
                <MenuContent>
                    <MenuItemCheckbox
            ...
            <SubMenu id="extra">
                <MenuTitle banner="https://nui-img/op/menu_job_bennys">Extras</MenuTitle>
                <MenuContent>
