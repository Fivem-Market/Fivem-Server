...
const BannerMap: Record<GarageType, string> = {
    [GarageType.Public]: 'https://nui-img/op/menu_garage_public',
    [GarageType.Private]: 'https://nui-img/op/menu_garage_private',
    [GarageType.Job]: 'https://nui-img/op/menu_garage_entreprise',
    [GarageType.JobLuxury]: 'https://nui-img/op/menu_garage_entreprise',
    [GarageType.Depot]: 'https://nui-img/op/menu_garage_pound',
    [GarageType.House]: 'https://nui-img/op/menu_garage_personal',
};
