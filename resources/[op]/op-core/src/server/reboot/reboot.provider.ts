...
export class RebootProvider {
    ...
    private async reboot() {
        ...
        exports['op-bank'].saveAccounts();
        exports['op-upw'].saveUpw();
        exports['op-inventory'].saveInventories();
        exports['op-inventory'].stopSyncInventories();
    ...
    private async thunder() {
        ...
        exports['op-api'].RemoveRebootMessage();
    ...
    private sendRebootMessage(minutes: 5 | 15) {
        exports['op-api'].RemoveRebootMessage();
        exports['op-api'].AddRebootMessage(minutes);
        emit(
