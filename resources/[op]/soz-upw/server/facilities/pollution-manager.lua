...
function PollutionManager:new(identifier, options)
    ...
    TriggerEvent("op-upw:server:onPollutionManagerReady")
...
function PollutionManager:UpdatePollution()
    ...
    if newPollutionLevel ~= previousPollutionLevel then
        TriggerEvent("op-upw:server:onPollutionLevelChanged", newPollutionLevel, previousPollutionLevel)
        TriggerClientEvent("op-upw:client:onPollutionLevelChanged", -1, newPollutionLevel, previousPollutionLevel)
    end
