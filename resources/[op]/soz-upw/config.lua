...
Config.Production = {
    Tick = 48000, -- in ms
    EnergyPerCell = {
        energy_cell_fossil = GetConvarInt("op_upw_energy_per_cell_fossil", 1),
        energy_cell_hydro = GetConvarInt("op_upw_energy_per_cell_hydro", 1),
        energy_cell_wind = GetConvarInt("op_upw_energy_per_cell_wind", 1),
    },
    WastePerHarvest = GetConvarInt("op_upw_waste_per_harvest", 1),
    HourBoost = {fossil1 = 1, hydro1 = 1, wind1 = 1},
}

Config.Consumption = {
    Tick = 60000, -- in ms
    EnergyPerTick = GetConvarInt("op_upw_consumption_energy_per_tick", 1) / 100, -- per connected player
    EnergyJobPerTick = GetConvarInt("op_upw_consumption_energy_job_per_tick", 1) / 100, -- per player on duty
}
