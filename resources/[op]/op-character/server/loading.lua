QBCore.Functions.CreateCallback("op-character:server:GetDefaultPlayer", function(source, cb)
...
QBCore.Functions.CreateCallback("op-character:server:LoginPlayer", function(source, cb, player)
