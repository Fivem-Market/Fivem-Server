...
QBCore.Functions.CreateCallback("op-character:server:GetPlayerCloakroom", function(source, cb)
...
QBCore.Functions.CreateCallback("op-character:server:SavePlayerClothe", function(source, cb, name)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback("op-character:server:DeletePlayerClothe", function(source, cb, id)
    local Player = QBCore.Functions.GetPlayer(source)
