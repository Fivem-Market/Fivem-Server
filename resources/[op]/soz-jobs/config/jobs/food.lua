...
FoodConfig.Categories = {
    ["wine"] = {icon = "https://cfx-nui-op-core/public/images/items/wine.png", label = "Vins"},
    ["grapejuice"] = {icon = "https://cfx-nui-op-core/public/images/items/grapejuice.png", label = "Jus"},
...
FoodConfig.Recipes = {
    ...
    -- JUICES
    ["grapejuice1"] = {category = "grapejuice", ingredients = {["grape1"] = 4}, output = 4},
    ["grapejuice2"] = {category = "grapejuice", ingredients = {["grape2"] = 4}, output = 4},
    ["grapejuice3"] = {category = "grapejuice", ingredients = {["grape3"] = 4}, output = 4},
    ["grapejuice4"] = {
        category = "grapejuice",
    ...
    ["sausage1"] = {
        category = "sausage",
        ingredients = {["tripe"] = 4, ["viande"] = 4, ["langue"] = 4, ["abat"] = 4, ["rognon"] = 4},
        output = 4,
    },
    ["sausage2"] = {
        category = "sausage",
