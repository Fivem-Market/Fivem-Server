...
local binModel, binLocation = GetHashKey("op_prop_bb_bin"), {}
...
CreateThread(function()
    exports["qb-target"]:AddBoxZone("garbage:duty", vector3(-615.5, -1622.18, 33.01), 0.6, 0.6,
                                    ...
                                    {options = opJobCore.Functions.GetDutyActions("garbage"), distance = 2.5})
...
HasExpiredItems = function()
    for _, item in pairs(PlayerData.items or {}) do
        if exports["op-utils"]:ItemIsExpired(item) then
            return true
        end
    end
    return false
