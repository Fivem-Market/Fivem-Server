...
function societyTaxPayment(society, percentage, tax)
    exports["op-monitor"]:Log("INFO", "Society " .. society .. " paid " .. tax .. "$ tax. Percentage: " .. percentage .. "%")
    ...
    for account, repartition in pairs(Config.SocietyTaxes.taxRepartition) do
        ...
        Account.TransfertMoney(society, account, money, function(success, reason)
            if success then
                exports["op-monitor"]:Log("INFO", "Public society " .. account .. " receive " .. money .. "$ tax. Percentage: " .. repartition .. "%")
            else
                exports["op-monitor"]:Log("ERROR", "Public society " .. account .. " can't receive " .. money .. "$ tax. Percentage: " .. repartition .. "%" ..
                                               " | Reason: " .. reason)
            end
        end)
    end
