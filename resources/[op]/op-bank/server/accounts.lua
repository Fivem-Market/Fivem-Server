...
MySQL.ready(function()
    ...
    local EnterpriseAccountNotLoaded = table.clone(opJobCore.Jobs)
        ...
        if result then
            for _, v in pairs(result) do
                ...
                elseif v.account_type == "business" then
                    Account.Create(v.businessid, opJobCore.Jobs[v.businessid] and opJobCore.Jobs[v.businessid].label or v.name, v.account_type, v.businessid,
                                   v.money)
