...
local http_endpoint = GetConvar("op_voip_mumble_http_endpoint", "http://127.0.0.1:8080")
local http_username = GetConvar("op_voip_mumble_http_username", "admin")
local http_password = GetConvar("op_voip_mumble_http_password", "changeme")
